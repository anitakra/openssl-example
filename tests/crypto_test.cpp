...
int main() {
  // SHA-1 - https://caligatio.github.io/jsSHA/
  ...
  // SHA-256 - Results from https://caligatio.github.io/jsSHA/
  ...
  // SHA-512 - Results from https://caligatio.github.io/jsSHA/
  ...
  // MD5 - Results from http://www.fileformat.info/tool/hash.htm
